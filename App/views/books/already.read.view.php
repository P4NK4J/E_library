...
<body style="background-color: rgba(101,157,189,0.4)">
    ...
    <div id="content" class="p-4 p-md-5 pt-5 text-black">
        <h2 class="mb-4 ml-3"><?= 'List of Books Read ' ?></h2>
        <?php
        $uid = $_SESSION['id'];
        ...
        <div class="table-responsive text-black mr-3 ml-3">
            <table class="table  w-50 mx-auto" id="myTable">
